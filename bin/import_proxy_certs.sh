#/!bin/sh
# Note this utility script was taken from: https://github.com/oss-review-toolkit/ort/blob/master/scripts/import_proxy_certs.sh with no modifications aside from this line.
#
